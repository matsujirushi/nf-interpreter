...
#if !defined(DEBUG_W5X00_SPI)
#define DEBUG_W5X00_SPI 0
#endif
...
void wizchip_initialize(void)
{
    ...
    {
#if DEBUG_RP2040 & DEBUG_W5X00_SPI
        printf(" W5x00 initialized: NG\n");
#endif
        return;
    }

#if DEBUG_RP2040 & DEBUG_W5X00_SPI
    printf("W5x00 initialized: OK\n");
#endif
    ...
    do
    {
        ...
        {
#if DEBUG_RP2040 & DEBUG_W5X00_SPI
            printf(" W5x00 initialized: Unknown PHY link status\n");
#endif
            return;
        }
        sleep_ms(100);
...
void wizchip_check(void)
{
    ...
    {
#if DEBUG_RP2040 & DEBUG_W5X00_SPI
        printf("wizchip_check: ERR : VERSION != 0x51, read value = 0x%02x\n", getVER());
#endif
        while (1)
            ;
    }
    ...
    {
#if DEBUG_RP2040 & DEBUG_W5X00_SPI
        printf("wizchip_check: ERR : VERSION != 0x04, read value = 0x%02x\n", getVERSIONR());
#endif
        while (1) {
            taskYIELD();
        }
