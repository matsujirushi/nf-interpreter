 ...
 */
void FLASH_SECTION flash_range_erase(uint32_t flash_offs, size_t count);
...
void FLASH_SECTION flash_range_program(uint32_t flash_offs, const uint8_t *data, size_t count);
 ...
 */
void FLASH_SECTION flash_get_unique_id(uint8_t *id_out);
 ...
 */
void FLASH_SECTION flash_do_cmd(const uint8_t *txbuf, uint8_t *rxbuf, size_t count);
