...
HRESULT Library_win_dev_i2c_native_Windows_Devices_I2c_I2cController::GetDeviceSelector___STATIC__STRING(
    CLR_RT_StackFrame &stack)
{
    NANOCLR_HEADER();
    {
        // Declare the device selector string whose max size is "I2C1,I2C2,I2C3," + terminator and init with the
        // terminator
        char deviceSelectorString[15 + 1] = {0};

        strcat(deviceSelectorString, "I2C1,I2C2,I2C3");
